...
in
{
  ...
  editorconfig = (mkNixago configs.editorconfig) {
    # see defaults at https://github.com/nadanix/std/blob/5ce7c9411337af3cb299bc9b6cc0dc88f4c1ee0e/src/data/configs/editorconfig.nix
    data = { };
  };

  # Tool Homepage: https://numtide.github.io/treefmt/
  treefmt = (mkNixago configs.treefmt) {
    # see defaults at https://github.com/nadanix/std/blob/5ce7c9411337af3cb299bc9b6cc0dc88f4c1ee0e/src/data/configs/treefmt.nix
    data = { };
  };
  ...
  lefthook = (mkNixago configs.lefthook) {
    # see defaults at https://github.com/nadanix/std/blob/5ce7c9411337af3cb299bc9b6cc0dc88f4c1ee0e/src/data/configs/lefthook.nix
    data = { };
  };
  githubsettings = (mkNixago configs.githubsettings) {
    # see defaults at https://github.com/nadanix/std/blob/5ce7c9411337af3cb299bc9b6cc0dc88f4c1ee0e/src/data/configs/githubsettings.nix
    data = {
      repository = {
        name = "CONFIGURE-ME";
  ...
  mdbook = (mkNixago configs.mdbook) {
    # see defaults at https://github.com/nadanix/std/blob/5ce7c9411337af3cb299bc9b6cc0dc88f4c1ee0e/src/data/configs/mdbook.nix
    data = {
