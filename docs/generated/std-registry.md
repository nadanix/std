...
| `lib`   | `dev:functions(mkArion\|mkMakes\|mkNixago\|mkShell)`, `ops:functions(lazyDerivation\|mkDevOCI\|mkMicrovm\|mkOCI\|mkOperable\|mkOperableScript\|mkSetup\|mkStandardOCI\|mkUser\|readYAML\|writeScript)`, `cfg:anything(adrgen\|cog\|conform\|editorconfig\|githubsettings\|just\|lefthook\|mdbook\|treefmt)` |
